...
public class DoktorAyarlarEkrani extends JPanel {
    ...
    public DoktorAyarlarEkrani(Kullanici kullanici) {
        ...
        cmbBildirim = createRow(content, "🔔 Bildirimler", new String[]{"Hepsi", "Sadece Acil", "Kapalı"}, mevcutAyarlar.getBildirimTercihi());
        ...
        scrollPane.getViewport().setBackground(BG_GRAY);
    ...
    private void saveAction() {
        ...
        try {
            if (ayarlarDAO.ayarlariKaydet(mevcutAyarlar)) {
                JOptionPane.showMessageDialog(this, "Doktor paneli ayarları başarıyla güncellendi.");
            }
        } catch (Exception e) {
